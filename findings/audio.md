...
**Area:** `Transcription/WhisperModelStore.swift`
...
**Note:** This applies only to STT (WhisperKit) models. LLM models (MLX) *are* disk-scanned via `DownloadedLLMModelStore` at `~/Library/Caches/models/mlx-community/`.
